...
import { aboutData } from "../../data/Event2Data";
        ...
        <div className="about-body index">
          <div className="about-description">
            <h2 style={{ color: theme.fogYellow }}>
              𝐊𝐈𝐃𝐒 𝐅𝐀𝐒𝐇𝐈𝐎𝐍 𝐂𝐀𝐋𝐄𝐍𝐃𝐀𝐑 𝐒𝐇𝐎𝐎𝐓{" "}
              <span style={{ color: theme.header }}>𝐀𝐓 𝐁𝐀𝐍𝐆𝐀𝐋𝐎𝐑𝐄 </span>
            </h2>
          ...
          <div className=" index">
            <a
              href={
                "https://www.instamojo.com/@fogfashionstudio/l2f0e1b0f85ba4332941d4b44a14cbbda/"
              }
              rel="im-checkout"
              data-text="Pay"
